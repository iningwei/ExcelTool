...
namespace ZGame.ZTable{
	public class t_subgame_normalReader{
		private t_subgame_normal[] entities;
		...
		static t_subgame_normalReader instance=null;
		public static t_subgame_normalReader Instance{
			get{
				if(instance==null){
					instance=new t_subgame_normalReader();
					instance.Load();
				}
				return instance;
			}
		...
		/// </summary>
		public t_subgame_normal GetEntityByRowIndex(int index){
		...
		/// </summary>
		public t_subgame_normal GetEntityByPrimaryKey(int key){
			int index;
			if(keyIndexMap.TryGetValue(key,out index)){
				...
				return default(t_subgame_normal);
			}
		}
		/// <summary>
		/// get all row datas
		/// </summary>
		public t_subgame_normal[] AllItems(){
