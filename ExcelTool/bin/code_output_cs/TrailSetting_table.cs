		...
		void Load(){
			Action<string> onTableLoad=(text)=>{
				...
				for(int i=0;i<count;i++){
					...
					entities[i].PropertyPlus=vals[15]=="囧"?null:vals[15].Trim();
					entities[i].BulletPrefabName=vals[16]=="囧"?null:vals[16].Trim();
					entities[i].BulletName=vals[17]=="囧"?null:vals[17].Trim();
